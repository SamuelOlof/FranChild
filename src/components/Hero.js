...
const Hero = () => {
    return (
        <div className='flex justify-center h-screen items-center mt-20 md:mt-20 lg:mt-0'>
            <div className='w-10/12 px-8 flex flex-col md:items-center md:space-y-5 lg:flex-row lg:justify-between '>
