    ...
    return (
        ...
        <div className='flex flex-col items-center my-20'>
            <div className='w-11/12 sm:w-10/12 px-4 mb-8 text-gray-700 leading-8'>
                <h1 className='mt-5 text-xl sm:text-2xl blue-text text-semibold'>Our priority at Talent Code Consulting is to drive change and deliver growth for your business.</h1>
                ...
                <p className='mt-4'>
                    When you choose Talent Code Consulting, one of our highly experienced, local People Directors will join your business on a flexible, part-time basis. They can work with you remotely or on-site depending on your need and they will get to know your business. More importantly, they get to know the people within it and deliver results.
                </p>
