    ...
    return (
        <>
            ...
            <div className='flex justify-center w-full'>
                <div className='w-11/12 sm:w-10/12 px-4 leading-8 text-center'>
                    <div className='my-8 md:my-20'>
                        <p>
                            <svg className="w-6 h-6 inline-block blue-text" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>  
                            <span className='ml-2'>+234 706 957 6677</span>
                        </p>
                        ...
                        <div className='mt-2 '>
                            <a href="http://twitter.com">
                                <IoLogoTwitter className='mr-4 inline-block blue-text h-6 w-6 hover:text-blue-700'/>
                            </a>

                            <a href="http://instagram.com">
                                <IoLogoInstagram className='mr-4 inline-block blue-text h-6 w-6 hover:text-blue-700'/>
                            </a>

                            <a href="http://facebook.com" >
                                <IoLogoFacebook className='mr-4 inline-block blue-text h-6 w-6 hover:text-blue-700'/>
                            </a>
                        </div>
                    </div>
